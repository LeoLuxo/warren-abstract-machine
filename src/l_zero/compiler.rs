...
mod tests {
	...
	fn test_flatten_term_bottomup() -> Result<()> {
		...
		assert_eq!(
			...
			(VarRegister(0), vec![
				MappingToken::Functor(VarRegister(0), Functor { name: "c".into(), arity: 0.into() })
			])
		);
		...
		assert_eq!(
			...
			(VarRegister(0), vec![
				MappingToken::Functor(VarRegister(6), Functor { name: "c".into(), arity: 0.into() }),
				MappingToken::Functor(VarRegister(5), Functor { name: "h".into(), arity: 2.into() }),
				MappingToken::VarRegister(VarRegister(6)),
				MappingToken::VarRegister(VarRegister(3)),
				MappingToken::Functor(VarRegister(4), Functor { name: "f".into(), arity: 1.into() }),
				MappingToken::VarRegister(VarRegister(5)),
				MappingToken::Functor(VarRegister(2), Functor { name: "h".into(), arity: 2.into() }),
				MappingToken::VarRegister(VarRegister(1)),
				MappingToken::VarRegister(VarRegister(3)),
				MappingToken::Functor(VarRegister(0), Functor { name: "p".into(), arity: 3.into() }),
				MappingToken::VarRegister(VarRegister(1)),
